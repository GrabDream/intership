...
<div class="menu_2"></div>
	<form id="form1"   name="form1" method="post" action="user_role_commit.php?action=add"  >
	<input type="hidden" name="tokenid" value="<?=$tokenid?>"/>
		<table id="adminTable" class="list wtwo">
				<caption>
				<div class="leftTop"></div>
				<div class="center"><?=_gettext('addsystemrole');?></div>
			...
			<tbody>
				<tr>
					...
					<td ><input type="text"  name="name" size="20" class="isNotEmpty isNameCH" msg="<?php echo _gettext('check_name32');?>" value="" tabindex="2" /></td>
				</tr>
						...
						<thead>
							<tr>
								...
								<th align="center" style="width:120px;">
									...
									<th align="center" style="width:119px;"><span class="divs"><?=_gettext('seachPermissions');?></span> <input type="checkbox" id="look_all" name="look_all" onclick="lookAll()" /></th>
							</tr>
						</thead>
					</table>
			<div class="tables">
				<table id="adminTable" class="add_list" >
						<?php
							...
							$idx_image=1;
							$commit_idx=1;
							for($idx = 1 ; $idx <= count($fuctions_array) ; $idx++)
							{
		...
		<table class="add_list list_title">
			<thead>
				<tr>
					...
					<th align="center" style="width:120px;"><span class="divs"><?=_gettext('editPermissions');?></span> <input type="checkbox" id="reporter_edit_all" onclick="reporter_checkAll()" /></th>
					<th align="center" style="width:119px;"><span class="divs"><?=_gettext('seachPermissions');?></span> <input type="checkbox" id="reporter_look_all" name="reporter_look_all" onclick="reporter_lookAll()" /></th>
				</tr>
			</thead>
		</table>
	<div class="tables">
		<table id="adminTable" class="add_list">
				<?php
					...
					$idx_level3=1;
					$commit_idx=201;
					for($idx = 0 ; $idx <= count($reporter_fuctions_array) ; $idx++)
					{
						if ($reporter_fuctions_array[$idx]['level']=='1')
						{
							...
							echo "<td style='width:120px;'><input type=\"checkbox\" id=\"rp_check_smal_all_".$idx_level1."\" class=\"rp_checks".$idx_level1."\"  name=\"rp_check_smal_all_".$idx_level1."\" $disabled $checked onclick=\"checkClass('rp_check_smal_all_".$idx_level1."','rp_checks".$idx_level1."','rp_looks".$idx_level1."')\" /></td>";
							echo "<td style='width:120px;'> <input type=\"checkbox\" id=\"rp_look_smal_all_".$idx_level1."\" class=\"rp_looks".$idx_level1."\" name=\"rp_look_smal_all_".$idx_level1."\" $disabled $checked onclick=\"LookClass('rp_look_smal_all_".$idx_level1."','rp_looks".$idx_level1."')\" /></td>";
							echo "</tr>";
							echo "<tbody id=\"one_parent".$idx_level1."\" >";
							$idx_level2=1;
							$idx_image++;
						...
						else if ($reporter_fuctions_array[$idx]['level']=='3')
						{
							...
							echo "<td style='width:120px;'><input type=\"checkbox\" id=\"rp_check".$idx_level1."_".$idx_level2."_".$idx_level3."[]\" class=\"three_rp_checks".$idx_level1."_".$idx_level2."\"  value=\"".$reporter_fuctions_array[$idx]['id']."\" name=\"r_".$reporter_fuctions_array[$idx]['id']."\" 
							onclick=\"clickchceck3('rp_check".$idx_level1."_".$idx_level2."_".$idx_level3."[]', 'rp_look".$idx_level1."_".$idx_level2."_".$idx_level3."[]')\" /></td>";
							echo "<td style='width:120px;'><input type=\"checkbox\" id=\"rp_look".$idx_level1."_".$idx_level2."_".$idx_level3."[]\" class=\"three_rp_looks".$idx_level1."_".$idx_level2."\"  value=\"".$reporter_fuctions_array[$idx]['id']."\" name=\"r_read_".$reporter_fuctions_array[$idx]['id']."\" /></td>";
							echo "</tr>";
							$idx_level3++;							
							$idx_image++;
							$commit_idx++;
